...
import { useAdminLoginMutation } from '../../../API/Authentication/authApi';
...
<div className="flex justify-center items-center min-h-screen">
      ...
      <div className="flex flex-col bg-white w-full max-w-110 px-10 py-10 space-y-6 shadow shadow-gray-400 rounded-2xl">

        <h2 className="text-2xl font-semibold text-gray-900">Hi Admin, <br/>Login to your account</h2>
        <Formik
          initialValues={{
            email: '',
            password: '',
